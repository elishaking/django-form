"""
Django settings for churchform project.
...
SECRET_KEY = '3t*wu7hdb7o$euiroc_)oyq#f5j5s55++u&y$l*cay(rgv1)lo'
...
WSGI_APPLICATION = 'churchform.wsgi.application'
